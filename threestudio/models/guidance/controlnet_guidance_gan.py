...
@threestudio.register("stable-diffusion-controlnet-guidance-gan")
class ControlNetGANGuidance(BaseObject):
    @dataclass
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if self.cfg.use_sds:
            ...
            loss_hifa = self.compute_grad_hifa(latents, rgb_BCHW_HW8, text_embeddings, image_cond, per_editing_step, start_editing_step)
            return loss_hifa
        else:
